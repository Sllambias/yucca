...
base_in = "/maps/projects/image/people/zcr545/datasets/amos22"
file_suffix = '.nii.gz'

#Train/Test Splits
labels_dir_tr = join(base_in, 'labelsTr')
images_dir_tr = join(base_in, 'imagesTr')
training_samples = subfiles(labels_dir_tr, join=False, suffix=file_suffix)

labels_dir_ts = join(base_in, 'labelsVa')
images_dir_ts = join(base_in, 'imagesVa')    
...
generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('CT', ),
                           labels={"0": "background", "1": "spleen", "2": "right kidney",
                                   "3": "left kidney", "4": "gall bladder", "5": "esophagus",
                                   "6": "liver", "7": "stomach", "8": "arota", "9": "postcava",
                                   "10": "pancreas", "11": "right adrenal gland",
