...
def convert(path: str, subdir: str = "brats21/training_data"):
    ...
    generate_dataset_json(join(target_base, 'dataset.json'), target_imagesTr, target_imagesTs, ('FLAIR', 'T1', 'T1CE', 'T2'),
                        labels={0: 'background', 1: 'necrotic tumor core', 2: 'peritumoral edematous/invaded tissue',
