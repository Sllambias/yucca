...
tform = Spatial(do_rot=True,
                ...
                do_scale=True,
                scale_factor=(1.5, 1.5))
print("Rotation, Deformation and Scaling WITHOUT cropping: ",
      timeit.timeit(lambda: tform(**deepcopy(datadict)), number=100))
...
tform = Spatial(do_crop=True,
                ...
                do_scale=True,
                scale_factor=(1.5, 1.5))
print("Rotation, Deformation and Scaling WITH cropping: ",
      timeit.timeit(lambda: tform(**deepcopy(datadict)), number=100))
