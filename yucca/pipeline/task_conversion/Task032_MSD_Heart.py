...
def convert(path: str = get_source_path(), subdir: str = "decathlon", subsubdir: str = "Task02_Heart"):
    # INPUT DATA
    ...
    for sTr in subfiles(images_dir_tr, join=False):
        ...
        assert verify_spacing_is_equal(image, label), f"spacing"
