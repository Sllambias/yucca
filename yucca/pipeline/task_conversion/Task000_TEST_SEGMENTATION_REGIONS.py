...
def convert(path: str = get_source_path(), subdir: str = "dataset_test0"):
    ...
    # OUTPUT DATA
    # Target names
    task_name = "Task000_TEST_SEGMENTATION_REGION"
    task_prefix = "TEST_SEGMENTATION_REGION"
    ...
    generate_dataset_json(
        ...
        regions={
            "FakeRegion0": {"priority": 1, "labels": [0]},
            "FakeRegion1": {"priority": 1, "labels": [1]},
            "FakeRegion2": {"priority": 1, "labels": [0, 1]},
        },
