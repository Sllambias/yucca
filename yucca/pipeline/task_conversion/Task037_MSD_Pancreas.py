...
def convert(path: str = get_source_path(), subdir: str = "decathlon", subsubdir: str = "Task07_Pancreas"):
    # INPUT DATA
    ...
    task_name = "Task037_MSD_Pancreas"
    ...
    generate_dataset_json(
        ...
        dataset_description="Decathlon: Pancreas",
