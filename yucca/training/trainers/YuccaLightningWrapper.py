...
class YuccaLightningManager:
    ...
    def load_checkpoint(self):
        ...
        print(self.trainer)
        self.trainer = self.trainer.load_checkpoint('/Users/zcr545/Desktop/Projects/repos/yucca_data/models/Task001_OASIS/UNet__YuccaPlanner/3D/YuccaConfigurator/0/lightning_logs/version_0/checkpoints/epoch=0-step=1.ckpt')
...
trainer = YuccaLightningManager(task = 'Task001_OASIS', max_epochs=1)
#trainer.run_training()
trainer.load_checkpoint()
trainer.predict_folder('/Users/zcr545/Desktop/Projects/repos/yucca_data/raw_data/Task001_OASIS/imagesTs',
