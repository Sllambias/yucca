from yucca.training.trainers.YuccaTrainerV2 import YuccaTrainer
from yucca.training.loss_functions.deep_supervision import DeepSupervisionLoss


class YuccaTrainerDS(YuccaTrainer):
    """
