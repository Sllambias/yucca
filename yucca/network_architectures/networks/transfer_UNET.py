...
class TinyUNet(YuccaNet):
    ...
    def out(self, x):
        return self.conv_op(self.filters, self.num_classes, kernel_size=1)
...
class OtherTinyUNet(TinyUNet):
    def __init__(self, *args, **kwargs) -> None:
        super(OtherTinyUNet, self).__init__(*args, **kwargs)
        self.new_out_conv = self.conv_op(self.filters, 5, kernel_size=1)

    def out(self, x):
        return self.new_out_conv(x)


Model1 = TinyUNet(1)
Model2 = OtherTinyUNet(1)
